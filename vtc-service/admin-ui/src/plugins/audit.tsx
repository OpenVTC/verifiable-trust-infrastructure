...
const EVENT_DESCRIPTIONS: Record<string, string> = {
  ...
  StepUpPasskeyChanged: "Member step-up passkey changed",
  ...
  VrcSuspended: "Relationship credential suspended",
  VrcRestored: "Relationship credential restored",
  VrcSuperseded: "Relationship credential superseded",
